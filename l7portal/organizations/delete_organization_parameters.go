...
type DeleteOrganizationParams struct {
	...
	/* UUID.
	   ...
	   The UUID of the organization to be deleted.
	*/
	UUID string
...
// WithUUID adds the uuid to the delete organization params
func (o *DeleteOrganizationParams) WithUUID(uuid string) *DeleteOrganizationParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the delete organization params
func (o *DeleteOrganizationParams) SetUUID(uuid string) {
	o.UUID = uuid
}
