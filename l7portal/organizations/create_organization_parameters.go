...
type CreateOrganizationParams struct {
	...
	/* Body.
	   ...
	   Creates an Organization based on the request body parameters. Name, AccountPlanUuid and Uuid fields are required. The Type field is optional and the Description field can be left empty.
	*/
...
func (o *CreateOrganizationParams) WithBody(body *models.OrganizationBasic) *CreateOrganizationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create organization params
func (o *CreateOrganizationParams) SetBody(body *models.OrganizationBasic) {
	o.Body = body
}
