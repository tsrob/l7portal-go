...
type UpdateOrganizationParams struct {
	...
	/* Body.
	   ...
	   Provides the values needed to set up the organization object.
	*/
	Body *models.OrganizationBasic

	/* UUID.

	   The UUID of the organization to be updated.
	*/
	UUID string
...
func (o *UpdateOrganizationParams) WithBody(body *models.OrganizationBasic) *UpdateOrganizationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update organization params
func (o *UpdateOrganizationParams) SetBody(body *models.OrganizationBasic) {
	o.Body = body
}

// WithUUID adds the uuid to the update organization params
func (o *UpdateOrganizationParams) WithUUID(uuid string) *UpdateOrganizationParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the update organization params
func (o *UpdateOrganizationParams) SetUUID(uuid string) {
	o.UUID = uuid
}
