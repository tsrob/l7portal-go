...
// WithUUID adds the uuid to the get request params
func (o *GetRequestParams) WithUUID(uuid string) *GetRequestParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the get request params
func (o *GetRequestParams) SetUUID(uuid string) {
	o.UUID = uuid
}
