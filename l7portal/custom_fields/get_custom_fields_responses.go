...
GetCustomFieldsOK get custom fields o k
*/
...
func (o *GetCustomFieldsOK) Error() string {
	return fmt.Sprintf("[GET /CustomFields][%d] getCustomFieldsOK  %+v", 200, o.Payload)
}
...
func (o *GetCustomFieldsOK) GetPayload() models.CustomFields {
	return o.Payload
}
