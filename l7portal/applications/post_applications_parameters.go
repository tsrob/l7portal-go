...
// WithApplicationDTO adds the applicationDTO to the post applications params
func (o *PostApplicationsParams) WithApplicationDTO(applicationDTO *models.ApplicationDto) *PostApplicationsParams {
	o.SetApplicationDTO(applicationDTO)
	return o
}

// SetApplicationDTO adds the applicationDTO to the post applications params
func (o *PostApplicationsParams) SetApplicationDTO(applicationDTO *models.ApplicationDto) {
