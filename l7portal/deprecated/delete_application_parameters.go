...
// WithUUID adds the uuid to the delete application params
func (o *DeleteApplicationParams) WithUUID(uuid string) *DeleteApplicationParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the delete application params
func (o *DeleteApplicationParams) SetUUID(uuid string) {
	o.UUID = uuid
}
